        ...
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="custom custom-select">
                    <option value="0"<?php echo isset($status) && $status == "0" ? "selected": "" ?>>Carro B1</option>
                    <option value="1"<?php echo isset($status) && $status == "1" ? "selected": "" ?>>Carro C1</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Carro B2</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Carro C2</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Carro B3</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Carro C3</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Moto A1</option>
                    <option value="2"<?php echo isset($status) && $status == "2" ? "selected": "" ?>>Moto A2</option>
                </select>
            </div>
